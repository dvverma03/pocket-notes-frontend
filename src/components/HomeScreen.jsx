  ...
  return (
    <div className='w-full h-screen bg-[#dae5f5]'>
      <div className='flex w-full justify-center pt-[10vh] items-center'>
        <img className='justify-center items-center w-[40vw]' src={HomeScreenImage} alt="" srcset="" />
      </div>
      <div className='text-4xl font-bold text-center'>Pocket Notes</div>
      <div className='justify-center items-center flex w-full '>

      <div className='text-[16px] font-medium w-[50%] pt-4 lh-20'>Send and receive messages without keeping your phone online.
